...
export default function Footer({
  ...
  return (
    <footer className="bg-white border-t border-black/5 text-[#111111] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 md:gap-8 text-left text-sm">
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <p className="text-xs text-black/50 leading-relaxed font-sans max-w-sm">
            ...
            <br />
            <br />
            Don't forget to follow our social pages to stay updated with the
            latest releases, updates, and exclusive content.
          </p>
        ...
        {/* Company Links */}
        <div className="space-y-4 md:justify-self-end text-left">
          <h4 className="font-display font-bold text-xs uppercase tracking-widest text-black/40">
            Company
          </h4>
          <ul className="space-y-3 font-sans font-semibold">
            <li>
              <a
                href="/privacy"
      ...
      <div className="border-t border-black/5 bg-brand-bg/50 py-8 text-xs text-black/40">
        <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <span className="text-center sm:text-left">
            © {new Date().getFullYear()} Editors Hub Store. All Rights Reserved. Designed & Developed
            by Aniket Visuals.
          </span>
        </div>
      </div>
