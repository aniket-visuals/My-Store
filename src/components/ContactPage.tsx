          ...
          <div className="space-y-8 lg:col-span-1">
            <div className="bg-white rounded-3xl p-8 shadow-sm border border-brand-dark/5 space-y-6">
              ...
              <div className="space-y-4">
                <a href="mailto:admin@editorshubstore.in" className="flex items-start gap-4 p-4 rounded-2xl bg-brand-bg hover:bg-brand-primary/5 transition-colors group">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-brand-dark/60 break-all">admin@editorshubstore.in</p>
                  </div>
                </a>
            ...
            <div className="bg-brand-dark rounded-3xl p-8 shadow-sm text-white">
              ...
              <a href="mailto:admin@editorshubstore.in" className="inline-flex items-center gap-2 text-sm font-bold bg-white text-brand-dark px-6 py-3 rounded-xl hover:bg-brand-primary hover:text-white transition-colors w-full justify-center">
